                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9 col-sm-9">
                            ...
                            <div class="list-results">
                                <div class="row">
                                    <div class="col-sm-12">
									<c:forEach items="${evaluationList}" var="g" varStatus="status">
										<div class="item-ads">
												<div class="row">
												<div class="col-sm-2 col-xs-3">
                                                    <div class="item-img">
                                                    <a href="detail?gId=${g.gId }">
                                                        <img alt="" src="/upload/${g.gUrl }">
                                                    </a>
                                                    </div>
                                                </div>
                                                <div class="col-sm-8 col-xs-6">
                                                    <div class="item-title">
                                                        <h4>用户：${g.username }对商品：${g.name }</h4>
                                                    </div>
                                                    <div class="item-meta">
                                                        <span>评价：${g.detail}</span>
                                                    </div>
