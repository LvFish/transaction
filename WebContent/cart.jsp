                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9 col-sm-9">
                            ...
                            <div class="list-results">
                                <div class="row">
                                    <div class="col-sm-12">
									<c:forEach items="${cartList}" var="g" varStatus="status">
										<div class="item-ads">
												<div class="row">
                                                ...
                                                <div class="col-sm-2 col-xs-3">
                                                    ...
                                                    <div class="item-action">
                                                    	<c:if test="${g.publishedStatus == 'sell' }">
                                                    		<button onclick="buy(${g.goodId})" class="btn btn-custom"><i class="fa fa-hand-pointer-o"></i></button>
                                                    	</c:if>
                                                    	<c:if test="${g.publishedStatus != 'sell' }">
                                                      	 	<button disabled="disabled" onclick="buy(${g.goodId})" class="btn btn-custom"><i class="fa fa-hand-pointer-o"></i></button>
                                                    	</c:if>
                                                    	<button onclick="deleteCart(${g.goodId})" class="btn btn-custom"><i class="fa fa-times"></i></button>
                                                    </div>
                                                </div>
                                            </div>
                                         </div>
